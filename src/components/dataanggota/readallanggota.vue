...
const readAllAnggota = 'http://localhost/pustaka-buku/readallanggota.php';
const insertAnggota = 'http://localhost/pustaka-buku/insertanggota.php';
const delAnggota = 'http://localhost/pustaka-buku/deleteanggota.php';
...
<template>
  <div class="intro">
    ...
    <tr>
      ...
      <td class="border" style="text-align: center;width: 750px"><strong>Nama Anggota</strong></td>
      ...
      <td class="border" style="text-align: center;width: 400px"><strong>Tanggal Terdaftar</strong></td>
