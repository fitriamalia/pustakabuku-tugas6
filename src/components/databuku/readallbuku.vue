...
const readAllBuku = 'http://localhost/pustaka-buku/readallbuku.php';
const insertBuku = 'http://localhost/pustaka-buku/insertbuku.php';
const delBuku = 'http://localhost/pustaka-buku/deletebuku.php';
...
<template>
  <div class="intro">
    ...
    <tr>
      ...
      <td class="border" style="text-align: center;width: 350px"><strong>Pengarang</strong></td>
      ...
      <td class="border" style="text-align: center;width: 150px"><strong>Tanggal Input</strong></td>
